  ...
  return (
    ...
    <motion.div
      initial={{ x: "-100%" }}
        ...
        viewport={{ once: false }}>
      {/* Seção Sobre Mim */}
      <section id="sobre" className="mt-8 flex justify-center items-center px-4 animated-element">
      ...
      <motion.div  
        ...
        transition={{ duration: 0.8, ease: "easeInOut" }}
        viewport={{ once: false }}>
          <section id="habilidades" className="px-4 py-16 mt-8 animated-element">
      ...
      <motion.div
        ...
        transition={{ duration: 0.8, ease: "easeInOut" }}
        viewport={{ once: false }}>
          <section id="projetos" className="px-4 py-16 animated-element">
